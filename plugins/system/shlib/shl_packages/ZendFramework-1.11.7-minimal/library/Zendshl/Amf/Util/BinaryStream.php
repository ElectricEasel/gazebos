 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zendshl_Amf_Util_BinaryStream
{
    /**
    ...
    public function __construct($stream)
    {
        if (!is_string($stream)) {
            ...
            throw new Zendshl_Amf_Exception('Inputdata is not of type String');
        }
     ...
     * @param  int $length
     * @return string
     * @throws Zendshl_Amf_Exception for buffer underrun
     */
    public function readBytes($length)
    {
        if (($length + $this->_needle) > $this->_streamLength) {
            require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Amf/Exception.php';
            throw new Zendshl_Amf_Exception('Buffer underrun at needle position: ' . $this->_needle . ' while requesting length: ' . $length);
        }
     ...
     *
     * @param  string $bytes
     * @return Zendshl_Amf_Util_BinaryStream
     */
