 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zendshl_Amf_Adobe_DbInspector
{

    /**
     * Connect to the database
     *
     * @param string $dbType Database adapter type for Zendshl_Db
     * @param array|object $dbDescription Adapter-specific connection settings
     * @return Zendshl_Db_Adapter_Abstract
     * @see Zendshl_Db::factory()
     */
    protected function _connect($dbType, $dbDescription)
    {
        ...
        return Zendshl_Db::factory($dbType, $dbDescription);
    }
