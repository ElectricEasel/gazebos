...
/** @see Zendshl_Amf_Parse_Deserializer */
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zendshl_Amf_Parse_Amf0_Deserializer extends Zendshl_Amf_Parse_Deserializer
{
    /**
     ...
     * @var int
     */
    protected $_objectEncoding = Zendshl_Amf_Constants::AMF0_OBJECT_ENCODING;
     ...
     * @throws Zendshl_Amf_Exception for invalid type
     */
    public function readTypeMarker($typeMarker = null)
    {
        ...
        switch($typeMarker) {
            ...
            // undefined
            case Zendshl_Amf_Constants::AMF0_UNDEFINED:
                return null;
            ...
            case Zendshl_Amf_Constants::AMF0_UNSUPPORTED:
                return null;

            // XML
            case Zendshl_Amf_Constants::AMF0_XML:
            ...
            default:
                ...
                throw new Zendshl_Amf_Exception('Unsupported marker type: ' . $typeMarker);
        }
    }
    ...
    public function readObject($object = null)
    {
        ...
        while (true) {
            ...
            $typeMarker = $this->_stream->readByte();
            if ($typeMarker != Zendshl_Amf_Constants::AMF0_OBJECTTERM ){
     ...
     *
     * @return object
     * @throws Zendshl_Amf_Exception for invalid reference keys
     */
    public function readReference()
    {
        ...
        if (!array_key_exists($key, $this->_reference)) {
            require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Amf/Exception.php';
            throw new Zendshl_Amf_Exception('Invalid reference key: '. $key);
        }
    ...
    /**
     * Convert AS Date to Zendshl_Date
     *
     * @return Zendshl_Date
     */
    public function readDate()
    {
        ...
        $date   = new Zendshl_Date($timestamp);
        return $date;
    }
     ...
     * @return object|array
     * @throws Zendshl_Amf_Exception if unable to load type
     */
    public function readTypedObject()
    {
        ...
        $loader = Zendshl_Amf_Parse_TypeLoader::loadType($className);
    ...
    {
        require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Amf/Parse/Amf3/Deserializer.php';
        $deserializer = new Zendshl_Amf_Parse_Amf3_Deserializer($this->_stream);
