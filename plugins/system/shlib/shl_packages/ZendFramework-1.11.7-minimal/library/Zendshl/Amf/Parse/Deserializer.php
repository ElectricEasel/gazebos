 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class Zendshl_Amf_Parse_Deserializer
{
    /**
     ...
     * Constructor
     *
     * @param  Zendshl_Amf_Parse_InputStream $stream
     * @return void
     */
    public function __construct(Zendshl_Amf_Parse_InputStream $stream)
    {
        $this->_stream = $stream;
    }
