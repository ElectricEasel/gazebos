...
/**
 * @see Zendshl_Amf_Value_Messaging_AcknowledgeMessage
 */
require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Amf/Value/Messaging/AcknowledgeMessage.php';
/**
 * @see Zendshl_Amf_Value_Messaging_AsyncMessage
 */
...
/**
 * @see Zendshl_Amf_Value_Messaging_ErrorMessage
 */
require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Amf/Value/Messaging/ErrorMessage.php';
/**
 * @see Zendshl_Amf_Value_Messaging_RemotingMessage
 */
require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Amf/Value/Messaging/RemotingMessage.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
final class Zendshl_Amf_Parse_TypeLoader
{
    /**
    ...
    public static $classMap = array (
        'flex.messaging.messages.AcknowledgeMessage' => 'Zendshl_Amf_Value_Messaging_AcknowledgeMessage',
        'flex.messaging.messages.ErrorMessage'       => 'Zendshl_Amf_Value_Messaging_AsyncMessage',
        'flex.messaging.messages.CommandMessage'     => 'Zendshl_Amf_Value_Messaging_CommandMessage',
        'flex.messaging.messages.ErrorMessage'       => 'Zendshl_Amf_Value_Messaging_ErrorMessage',
        'flex.messaging.messages.RemotingMessage'    => 'Zendshl_Amf_Value_Messaging_RemotingMessage',
        'flex.messaging.io.ArrayCollection'          => 'Zendshl_Amf_Value_Messaging_ArrayCollection',
    );
    ...
    /**
     * @var Zendshl_Loader_PluginLoader_Interface
     */
     ...
     *
     * @param Zendshl_Loader_PluginLoader_Interface $loader
     */
    public static function setResourceLoader(Zendshl_Loader_PluginLoader_Interface $loader)
    {
    ...
    public static function handleResource($resource)
    {
        if(!self::$_resourceLoader) {
            ...
            throw new Zendshl_Amf_Exception('Unable to handle resources - resource plugin loader not set');
        }
        try {
            while(is_resource($resource)) {
                ...
                if(!$resclass) {
                    require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Amf/Exception.php';
                    throw new Zendshl_Amf_Exception('Can not serialize resource type: '. get_resource_type($resource));
                }
                $parser = new $resclass();
                if(is_callable(array($parser, 'parse'))) {
                    ...
                    require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Amf/Exception.php';
                    throw new Zendshl_Amf_Exception("Could not call parse() method on class $resclass");
                }
            }
            return $resource;
        } catch(Zendshl_Amf_Exception $e) {
            throw new Zendshl_Amf_Exception($e->getMessage(), $e->getCode(), $e);
        } catch(Exception $e) {
            require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Amf/Exception.php';
            throw new Zendshl_Amf_Exception('Can not serialize resource type: '. get_resource_type($resource), 0, $e);
        }
    }
}
