 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zendshl_Server_Definition implements Countable, Iterator
{
    /**
     * @var array Array of Zendshl_Server_Method_Definition objects
     */
     ...
     *
     * @param  array|Zendshl_Server_Method_Definition $method
     * @param  null|string $name
     * @return Zendshl_Server_Definition
     * @throws Zendshl_Server_Exception if duplicate or invalid method provided
     */
    public function addMethod($method, $name = null)
    {
        if (is_array($method)) {
            require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Server/Method/Definition.php';
            $method = new Zendshl_Server_Method_Definition($method);
        } elseif (!$method instanceof Zendshl_Server_Method_Definition) {
            require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Server/Exception.php';
            throw new Zendshl_Server_Exception('Invalid method provided');
        }
        ...
        if (null === $name) {
            require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Server/Exception.php';
            throw new Zendshl_Server_Exception('No method name provided');
        }

        if (!$this->_overwriteExistingMethods && array_key_exists($name, $this->_methods)) {
            require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Server/Exception.php';
            throw new Zendshl_Server_Exception(sprintf('Method by name of "%s" already exists', $name));
        }
     ...
     *
     * @param  array $methods Array of Zendshl_Server_Method_Definition objects or arrays
     * @return Zendshl_Server_Definition
     */
     ...
     *
     * @param  string $method
     * @return null|Zendshl_Server_Method_Definition
     */
     ...
     *
     * @return array Array of Zendshl_Server_Method_Definition objects
     */
