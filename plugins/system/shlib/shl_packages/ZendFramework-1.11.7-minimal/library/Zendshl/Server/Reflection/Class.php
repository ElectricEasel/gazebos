...
/**
 * Zendshl_Server_Reflection_Method
 */
require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Server/Reflection/Method.php';

/**
 * Class/Object reflection
 *
 * Proxies calls to a ReflectionClass object, and decorates getMethods() by
 * creating its own list of {@link Zendshl_Server_Reflection_Method}s.
 *
 * @category   Zend
 * @package    Zendshl_Server
 ...
 */
class Zendshl_Server_Reflection_Class
{
    /**
    ...
    /**
     * Array of {@link Zendshl_Server_Reflection_Method}s
     * @var array
     */
     ...
     * {@link Zendshl_Server_Reflection_Method}. Sets reflection object property.
     *
    ...
    public function __construct(ReflectionClass $reflection, $namespace = null, $argv = false)
    {
        ...
        foreach ($reflection->getMethods() as $method) {
            ...
            if ($method->isPublic()) {
                ...
                $this->_methods[] = new Zendshl_Server_Reflection_Method($this, $method, $this->getNamespace(), $argv);
            }
        }
    }
    ...
    public function __call($method, $args)
    {
        ...
        throw new Zendshl_Server_Reflection_Exception('Invalid reflection method');
    }
    ...
    /**
     * Return array of dispatchable {@link Zendshl_Server_Reflection_Method}s.
     *
     * @access public
     * @return array
     */
