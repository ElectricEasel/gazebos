...
/**
 * @see Zendshl_Crypt_Math_BigInteger_Interface
 */
require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Crypt/Math/BigInteger/Interface.php';

/**
 * Support for arbitrary precision mathematics in PHP.
 *
 * Zendshl_Crypt_Math_BigInteger_Bcmath is a wrapper across the PHP BCMath
 * extension.
 *
 * @category   Zend
 * @package    Zendshl_Crypt
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zendshl_Crypt_Math_BigInteger_Bcmath implements Zendshl_Crypt_Math_BigInteger_Interface
{
