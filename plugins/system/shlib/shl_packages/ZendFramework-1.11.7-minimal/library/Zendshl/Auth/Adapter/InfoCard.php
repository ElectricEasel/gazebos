...
/**
 * @see Zendshl_InfoCard
 */
require_once SHLIB_PATH_TO_ZEND . 'Zendshl/InfoCard.php';

/**
 * A Zendshl_Auth Authentication Adapter allowing the use of Information Cards as an
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zendshl_Auth_Adapter_InfoCard implements Zendshl_Auth_Adapter_Interface
{
    /**
    ...
    /**
     * The instance of Zendshl_InfoCard
     *
     * @var Zendshl_InfoCard
     */
    protected $_infoCard;
    ...
    public function __construct($strXmlDocument)
    {
        ...
        $this->_infoCard = new Zendshl_InfoCard();
    }

    /**
     * Sets the InfoCard component Adapter to use
     *
     * @param  Zendshl_InfoCard_Adapter_Interface $a
     * @return Zendshl_Auth_Adapter_InfoCard Provides a fluent interface
     */
    public function setAdapter(Zendshl_InfoCard_Adapter_Interface $a)
    {
     ...
     *
     * @return Zendshl_InfoCard_Adapter_Interface
     */
     ...
     *
     * @return Zendshl_InfoCard_Cipher_PKI_Interface
     */
     ...
     *
     * @param  Zendshl_InfoCard_Cipher_PKI_Interface $cipherObj
     * @return Zendshl_Auth_Adapter_InfoCard Provides a fluent interface
     */
    public function setPKICipherObject(Zendshl_InfoCard_Cipher_PKI_Interface $cipherObj)
    {
     ...
     *
     * @return Zendshl_InfoCard_Cipher_Symmetric_Interface
     */
     ...
     *
     * @param  Zendshl_InfoCard_Cipher_Symmetric_Interface $cipherObj
     * @return Zendshl_Auth_Adapter_InfoCard Provides a fluent interface
     */
    public function setSymCipherObject(Zendshl_InfoCard_Cipher_Symmetric_Interface $cipherObj)
    {
     ...
     * @throws Zendshl_InfoCard_Exception
     * @return Zendshl_Auth_Adapter_InfoCard Provides a fluent interface
     */
     ...
     */
    public function addCertificatePair($private_key_file, $public_key_file, $type = Zendshl_InfoCard_Cipher::ENC_RSA_OAEP_MGF1P, $password = null)
    {
     ...
     *
     * @return Zendshl_Auth_Result The result of the authentication
     */
    public function authenticate()
    {
        try {
            ...
            return new Zendshl_Auth_Result(Zendshl_Auth_Result::FAILURE , null, array('Exception Thrown',
                                                                                $e->getMessage(),
                                                                                $e->getTraceAsString(),
                                                                                serialize($e)));
        }
        ...
        if(!$claims->isValid()) {
            switch($claims->getCode()) {
                case Zendshl_infoCard_Claims::RESULT_PROCESSING_FAILURE:
                    return new Zendshl_Auth_Result(
                        Zendshl_Auth_Result::FAILURE,
                        $claims,
                        array(
                            'Processing Failure',
                            $claims->getErrorMsg()
                    ...
                    break;
                case Zendshl_InfoCard_Claims::RESULT_VALIDATION_FAILURE:
                    return new Zendshl_Auth_Result(
