...
/**
 * Zendshl_Http_Response represents an HTTP 1.0 / 1.1 response message. It
...
class Zendshl_Http_Response
{
     ...
     *
     * In most cases, you would use Zendshl_Http_Response::fromString to parse an HTTP
     * response string and create a new Zendshl_Http_Response object.
     *
    ...
    public function __construct($code, array $headers, $body = null, $version = '1.1', $message = null)
    {
        ...
        if (self::responseCodeAsText($code) === null) {
            ...
            throw new Zendshl_Http_Exception("{$code} is not a valid HTTP response code");
        }
        ...
        foreach ($headers as $name => $value) {
            if (is_int($name)) {
                ...
                if (count($header) != 2) {
                    require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Http/Exception.php';
                    throw new Zendshl_Http_Exception("'{$value}' is not a valid HTTP header");
                }
    ...
    public static function decodeChunkedBody($body)
    {
        ...
        while (trim($body)) {
            if (! preg_match("/^([\da-fA-F]+)[^\r\n]*\r\n/sm", $body, $m)) {
                require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Http/Exception.php';
                throw new Zendshl_Http_Exception("Error parsing body - doesn't seem to be a chunked message");
            }
    ...
    public static function decodeGzip($body)
    {
        if (! function_exists('gzinflate')) {
            require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Http/Exception.php';
            throw new Zendshl_Http_Exception(
    ...
    /**
     * Create a new Zendshl_Http_Response object from a string
     *
     * @param string $response_str
    ...
    public static function fromString($response_str)
    {
        ...
        return new Zendshl_Http_Response($code, $headers, $body, $version, $message);
    }
}
