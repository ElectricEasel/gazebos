 ...
 *
 * @category   Zend
 * @package    Zendshl_Http_UserAgent
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zendshl_Http_UserAgent implements Serializable
{
    /**
     ...
     * Identified device
     *
     * @var Zendshl_Http_UserAgent_Device
     */
    protected $_device;
     ...
     *
     * @var Zendshl_Http_UserAgent_Storage
     */
    protected $_storage;
     ...
     * Constructor
     *
     * @param  null|array|Zendshl_Config|ArrayAccess $options
     * @return void
     */
     ...
     * Configure instance
     *
     * @param  array|Zendshl_Config|ArrayAccess $options
     * @return Zendshl_Http_UserAgent
     */
    public function setOptions($options)
    {
        ...
        if (!is_array($options)
            ...
            require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Http/UserAgent/Exception.php';
            throw new Zendshl_Http_UserAgent_Exception(sprintf(
                'Invalid argument; expected array, Zendshl_Config object, or object implementing ArrayAccess and Traversable; received %s',
    ...
    protected function _match($deviceClass)
    {
        ...
        if (!$r->implementsInterface('Zendshl_Http_UserAgent_Device')) {
            throw new Zendshl_Http_UserAgent_Exception(sprintf(
                'Invalid device class provided ("%s"); must implement Zendshl_Http_UserAgent_Device',
                $deviceClass
            ));
        }
     ...
     * @return string
     * @throws Zendshl_Loader_PluginLoader_Exception if unable to load UA device
     */
    protected function _getUserAgentDevice($browserType)
    {
        ...
        if (isset($this->_config[$browserType])
            ...
            if (is_array($deviceConfig) && isset($deviceConfig['classname'])) {
                ...
                $prefix = isset($deviceConfig['prefix']) ? $deviceConfig['prefix'] : 'Zendshl_Http_UserAgent';
     ...
     * @return Zendshl_Http_UserAgent_Storage
     */
     ...
     *
     * @param  Zendshl_Http_UserAgent_Storage $storage
     * @return Zendshl_Http_UserAgent
     */
    public function setStorage(Zendshl_Http_UserAgent_Storage $storage)
    {
        if ($this->_immutable) {
            require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Http/UserAgent/Exception.php';
            throw new Zendshl_Http_UserAgent_Exception(
    ...
    /**
     * Config parameters is an Array or a Zendshl_Config object
     *
     ...
     * capabilities.
     *
     * @return Zendshl_Http_UserAgent_Device $device
     */
    public function getDevice()
    {
        ...
        if (!$storage->isEmpty()) {
            ...
            // Zendshl_Http_UserAgent object is serialized in the session
            $object = $storage->read();
     ...
     * @return void
     * @throws Zendshl_Http_UserAgent_Exception on invalid parameter
     */
     ...
     * @param  string|Zendshl_Loader_PluginLoader $loader
     * @return Zendshl_Http_UserAgent
     */
    public function setPluginLoader($type, $loader)
    {
        ...
        if (is_string($loader)) {
            if (!class_exists($loader)) {
                ...
                Zendshl_Loader::loadClass($loader);
            }
            $loader = new $loader();
        ...
        if (!$loader instanceof Zendshl_Loader_PluginLoader) {
            require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Http/UserAgent/Exception.php';
            throw new Zendshl_Http_UserAgent_Exception(sprintf(
                'Expected an object extending Zendshl_Loader_PluginLoader; received %s',
                get_class($loader)
            ));
        }

        $basePrefix = 'Zendshl_Http_UserAgent_';
    ...
    public function getPluginLoader($type)
    {
        ...
        if (!isset($this->_loaders[$type])) {
            ...
            $this->setPluginLoader($type, new Zendshl_Loader_PluginLoader());
        }
     ...
     * @param  string $type
     * @return string
     * @throws Zendshl_Http_UserAgent_Exception on invalid type
     */
     ...
     * user agent
     *
     * @return Zendshl_Http_UserAgent_Result
     */
