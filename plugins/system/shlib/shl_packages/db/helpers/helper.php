...
class ShlDbHelper {
  ...
  private static $_defaultQueryCacheTableExclusionList = array( '#__schemas','#__session', '#__update_categories', '#__update_sites', '#__update_sites_extensions', '#__updates');
   ...
   */
  public static function registerDb( $name, & $db, $dataset = self::SHL_DEFAULT, $opType = self::OP_TYPE_DEFAULT, $weight = self::DEFAULT_WEIGHT, $enableQueryCache = true, $exclusionList = null) {
   ...
   */
  public static function selectResult( $table, $aColList = array( '*'), $mWhere = '', $aWhereData = array(), $orderBy = array(), $offset = 0, $lines = 0, $opType = '') {
   ...
   * @throw none (underlying database layer does throw errors)
   */
  public static function selectResultArray( $table, $aColList = array( '*'), $mWhere = '', $aWhereData = array(), $orderBy = array(), $offset = 0, $lines = 0, $opType = '') {
   ...
   * @throw none (underlying database layer does throw errors)
   */
  public static function selectColumn( $table, $aColList = array( '*'), $mWhere = '', $aWhereData = array(), $orderBy = array(), $offset = 0, $lines = 0, $opType = '') {
   ...
   * @throw none (underlying database layer does throw errors)
   */
  public static function selectAssoc( $table, $aColList = array( '*'), $mWhere = '', $aWhereData = array(), $orderBy = array(), $offset = 0, $lines = 0, $opType = '') {
   ...
   * @throw none (underlying database layer does throw errors)
   */
  public static function selectAssocList( $table, $aColList = array( '*'), $mWhere = '', $aWhereData = array(), $orderBy = array(), $offset = 0, $lines = 0, $key = '', $opType = '') {
   ...
   * @throw none (underlying database layer does throw errors)
   */
  public static function selectObject( $table, $aColList = array( '*'), $mWhere = '', $aWhereData = array(), $orderBy = array(), $offset = 0, $lines = 0, $opType = '') {
   ...
   * @throw none (underlying database layer does throw errors)
   */
  public static function selectObjectList( $table, $aColList = array( '*'), $mWhere = '', $aWhereData = array(), $orderBy = array(), $offset = 0, $lines = 0, $key='', $opType = '') {
   ...
   * @return object the db object
   */
  public static function runQuotedQuery( $query, $nameQuoted = array(), $quoted = array(), $namePlaceHolder = '??', $dataPlaceHolder = '?', $opType = '') {
  ...
  protected static function _setSelectQuery( $table, $aColList = array( '*'), $mWhere = '', $aWhereData = array(), $orderBy = array(), $offset = 0, $lines = 0, $opType = '') {
  ...
  private static function _createDefaultDatabase( $name) {
    ...
    self::$_databases[$name] = new ShlDbClass_Dbrecord( $db, $name, self::DEFAULT_WEIGHT, self::$_queryCacheEnabled, self::$_defaultQueryCacheTableExclusionList, self::$_joomlaQueryCacheEnabled);
