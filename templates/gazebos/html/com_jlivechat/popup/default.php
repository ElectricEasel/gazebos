...
<style type="text/css">
#livechat_container {
	background:url(/templates/gazebos/images/bg_content.png);
	position:relative;
	color:#3c2313;
}
#livechat_container .intro_wrapper p {
	color:#3c2313;
	text-align: center;
	line-height: 20px;
	font-size:14px;
...
#livechat_container .close-wnd-icn {
	background:url(/templates/gazebos/images/close_icon.png) no-repeat center center scroll transparent !important;
	width:28px;
	height:28px;
	display:block;
	top:5px;
...
#livechat_container #jlc_prechat_container {
	color:#3c2313;
}
...
#livechat_container .visitor-msg,
#livechat_container .operator-msg {
	margin-bottom:0;
}
#livechat_container #jlc_inchat_container #status-display-outer {
	color:#3c2313;
}
...
#livechat_container #jlc_inchat_container div#session-content-display {
	height:185px;
}
</style>
<div id="livechat_container">
	<img src="/templates/gazebos/images/chat_logo.png" style="padding-top:10px;"/>
	<a href="javascript:void(0);" onclick="closeWnd();" class="close-wnd-icn">&nbsp;</a>
	<div class="livechat_inner">
		<h2 style="text-align:center;font-family:Times,serif;color:#355a04;font-weight:normal;font-size:22px;">WELCOME TO OUR LIVE SUPPORT!</h2>
		...
		<div id="jlc_prechat_container">
			...
			<span class="jlc-right start-btn-wrapper">
			    <button id="start_button" name="start_button" type="button"><?php echo JText::_('START'); ?> &rsaquo;</button>
			</span>
			<div class="jlc-clr">&nbsp;</div>
		    </form>
		</div>
