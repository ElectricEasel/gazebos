...
class Sh404sefViewEditnotfound extends ShlMvcView_Base
{
	...
	public function display($tpl = null)
	{
		...
		else
		{
			...
			$this
				->assign('toolbarTitle',
					Sh404sefHelperGeneral::makeToolbarTitle(JText::_('COM_SH404SEF_NOT_FOUND_ENTER_REDIRECT'), $icon = 'sh404sef',
	...
	private function _makeToolbar($params = null)
	{
		...
		$bar
			->appendButton('Shajaxbutton', 'save', 'Save', "index.php?option=com_sh404sef&c=editnotfound&task=save&shajax=1&tmpl=component", $params);
