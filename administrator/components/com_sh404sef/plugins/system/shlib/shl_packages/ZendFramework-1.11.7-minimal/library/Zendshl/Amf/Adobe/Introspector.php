...
/** @see Zendshl_Reflection_Class */
require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Reflection/Class.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zendshl_Amf_Adobe_Introspector
{
    /**
     * Options used:
     * - server: instance of Zendshl_Amf_Server to use
    ...
    public function introspect($serviceClass, $options = array())
    {
        ...
        if (!class_exists($serviceClass)) {
            ...
            Zendshl_Loader::loadClass($serviceClass, $this->_getServicePath());
        }
        ...
        $r = Zendshl_Server_Reflection::reflectClass($serviceClass);
     ...
     * @return unknown_type
     */
    public function initAcl(Zendshl_Acl $acl)
    {
    ...
    protected function _addClassAttributes($typename, DOMElement $typexml)
    {
        ...
        $rc = new Zendshl_Reflection_Class($typename);
     ...
     *
     * @param  Zendshl_Server_Reflection_Class $refclass
     * @param  DOMElement $target target XML element
     * @return void
     */
    protected function _addService(Zendshl_Server_Reflection_Class $refclass, DOMElement $target)
    {
     ...
     *
     * @param  Zendshl_Reflection_Property $prop reflection property object
     * @return string Property type
     */
    protected function _getPropertyType(Zendshl_Reflection_Property $prop)
    {
    ...
    protected function _phpTypeToAS($typename)
    {
        ...
        if (false !== ($asname = Zendshl_Amf_Parse_TypeLoader::getMappedClassName($typename))) {
            return $asname;
        }
