...
/** @see Zendshl_Amf_Parse_OutputStream */
require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Amf/Parse/OutputStream.php';

/** @see Zendshl_Amf_Parse_Amf0_Serializer */
require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Amf/Parse/Amf0/Serializer.php';
...
class Zendshl_Amf_Response
{
    ...
    /**
     * Array of Zendshl_Amf_Value_MessageBody objects
     * @var array
     */
    protected $_bodies = array();

    /**
     * Array of Zendshl_Amf_Value_MessageHeader objects
     * @var array
     */
    protected $_headers = array();

    /**
     * @var Zendshl_Amf_Parse_OutputStream
     */
    ...
    {
        $this->_outputStream = new Zendshl_Amf_Parse_OutputStream();
     ...
     *
     * @param  Zendshl_Amf_Parse_OutputStream $stream
     * @return Zendshl_Amf_Response
     */
    public function writeMessage(Zendshl_Amf_Parse_OutputStream $stream)
    {
        ...
        foreach ($this->getAmfHeaders() as $header) {
            $serializer = new Zendshl_Amf_Parse_Amf0_Serializer($stream);
            $stream->writeUTF($header->name);
            $stream->writeByte($header->mustRead);
            $stream->writeLong(Zendshl_Amf_Constants::UNKNOWN_CONTENT_LENGTH);
        ...
        foreach ($this->_bodies as $body) {
            ...
            $markerType = ($this->_objectEncoding == Zendshl_Amf_Constants::AMF0_OBJECT_ENCODING) ? null : Zendshl_Amf_Constants::AMF0_AMF3;
     ...
     *
     * @param  Zendshl_Amf_Value_MessageBody $body
     * @return Zendshl_Amf_Response
     */
    public function addAmfBody(Zendshl_Amf_Value_MessageBody $body)
    {
        $this->_bodies[] = $body;
        return $this;
    }
     ...
     *
     * @param  Zendshl_Amf_Value_MessageHeader $header
     * @return Zendshl_Amf_Response
     */
    public function addAmfHeader(Zendshl_Amf_Value_MessageHeader $header)
    {
     ...
     *
     * @return array Array of Zendshl_Amf_Value_MessageHeader objects
     */
