 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zendshl_Server_Method_Prototype
{
    /**
     ...
     * @return Zendshl_Server_Method_Prototype
     */
    ...
    {
        if ($parameter instanceof Zendshl_Server_Method_Parameter) {
            ...
            $parameter = new Zendshl_Server_Method_Parameter(array(
     ...
     * @return null|Zendshl_Server_Method_Parameter
     */
