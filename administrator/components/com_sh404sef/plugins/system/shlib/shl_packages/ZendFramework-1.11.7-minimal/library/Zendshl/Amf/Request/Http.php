...
/** @see Zendshl_Amf_Request */
require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Amf/Request.php';

/**
 * AMF Request object -- Request via HTTP
 *
 * Extends {@link Zendshl_Amf_Request} to accept a request via HTTP. Request is
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zendshl_Amf_Request_Http extends Zendshl_Amf_Request
{
    /**
     * Raw AMF request
     * @var string
