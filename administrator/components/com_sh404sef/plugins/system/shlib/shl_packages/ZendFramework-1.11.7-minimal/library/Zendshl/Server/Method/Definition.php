 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zendshl_Server_Method_Definition
{
    /**
     * @var Zendshl_Server_Method_Callback
     */
    protected $_callback;
    ...
    /**
     * @var array Array of Zendshl_Server_Method_Prototype objects
     */
     ...
     * Set method callback
     *
     * @param  array|Zendshl_Server_Method_Callback $callback
     * @return Zendshl_Server_Method_Definition
     */
    public function setCallback($callback)
    {
        if (is_array($callback)) {
            ...
            $callback = new Zendshl_Server_Method_Callback($callback);
        } elseif (!$callback instanceof Zendshl_Server_Method_Callback) {
            require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Server/Exception.php';
            throw new Zendshl_Server_Exception('Invalid method callback provided');
        }
     ...
     *
     * @param  array|Zendshl_Server_Method_Prototype $prototype
     * @return Zendshl_Server_Method_Definition
     */
    public function addPrototype($prototype)
    {
        if (is_array($prototype)) {
            ...
            $prototype = new Zendshl_Server_Method_Prototype($prototype);
        } elseif (!$prototype instanceof Zendshl_Server_Method_Prototype) {
            require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Server/Exception.php';
            throw new Zendshl_Server_Exception('Invalid method prototype provided');
        }
     ...
     *
     * @param  array $prototypes Array of Zendshl_Server_Method_Prototype objects or arrays
     * @return Zendshl_Server_Method_Definition
     */
     ...
     * Get all prototypes
     *
     * @return array $prototypes Array of Zendshl_Server_Method_Prototype objects or arrays
     */
    ...
    public function setObject($object)
    {
        if (!is_object($object) && (null !== $object)) {
            require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Server/Exception.php';
            throw new Zendshl_Server_Exception('Invalid object passed to ' . __CLASS__ . '::' . __METHOD__);
        }
        $this->_object = $object;
        return $this;
    }
