...
/**
 * @see Zendshl_OpenId_Consumer
 */
require_once SHLIB_PATH_TO_ZEND . 'Zendshl/OpenId/Consumer.php';


/**
 * A Zendshl_Auth Authentication Adapter allowing the use of OpenID protocol as an
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zendshl_Auth_Adapter_OpenId implements Zendshl_Auth_Adapter_Interface
{
    /**
     ...
     *
     * @var Zendshl_OpenId_Consumer_Storage
     */
     ...
     *
     * @var Zendshl_Controller_Response_Abstract
     */
     ...
     *
     * @var Zendshl_Http_Client $_httpClient
     */
     ...
     * @param Zendshl_OpenId_Consumer_Storage $storage an optional implementation
     *        of a storage object
     * @param string $returnTo HTTP URL to redirect response from server to
     * @param string $root HTTP URL to identify consumer on server
     * @param mixed $extensions extension object or array of extensions objects
     * @param Zendshl_Controller_Response_Abstract $response an optional response
     *        object to perform HTTP or HTML form redirection
     * @return void
     */
    public function __construct($id = null,
                                Zendshl_OpenId_Consumer_Storage $storage = null,
                                $returnTo = null,
                                $root = null,
                                $extensions = null,
                                Zendshl_Controller_Response_Abstract $response = null) {
        $this->_id         = $id;
     ...
     *
     * @param  string $id the identity value
     * @return Zendshl_Auth_Adapter_OpenId Provides a fluent interface
     */
     ...
     *
     * @param  Zendshl_OpenId_Consumer_Storage $storage
     * @return Zendshl_Auth_Adapter_OpenId Provides a fluent interface
     */
    public function setStorage(Zendshl_OpenId_Consumer_Storage $storage)
    {
        $this->_storage = $storage;
        return $this;
    }
     ...
     *
     * @param Zendshl_Http_Client $client HTTP client object to be used
     */
     ...
     * Defined by Zendshl_Auth_Adapter_Interface.
     *
    ...
    public function authenticate() {
        $id = $this->_id;
        if (!empty($id)) {
            $consumer = new Zendshl_OpenId_Consumer($this->_storage);
