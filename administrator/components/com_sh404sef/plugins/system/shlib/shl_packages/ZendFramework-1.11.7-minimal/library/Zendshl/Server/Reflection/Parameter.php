 ...
 */
class Zendshl_Server_Reflection_Parameter
{
    /**
    ...
    public function setType($type)
    {
        if (!is_string($type) && (null !== $type)) {
            require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Server/Reflection/Exception.php';
            throw new Zendshl_Server_Reflection_Exception('Invalid parameter type');
        }
    ...
    public function setDescription($description)
    {
        if (!is_string($description) && (null !== $description)) {
            require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Server/Reflection/Exception.php';
            throw new Zendshl_Server_Reflection_Exception('Invalid parameter description');
        }
