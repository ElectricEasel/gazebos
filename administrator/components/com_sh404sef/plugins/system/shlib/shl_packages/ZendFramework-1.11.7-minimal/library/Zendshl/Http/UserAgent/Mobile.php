...
require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Http/UserAgent/AbstractDevice.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zendshl_Http_UserAgent_Mobile extends Zendshl_Http_UserAgent_AbstractDevice
{

    const DEFAULT_FEATURES_ADAPTER_CLASSNAME = 'Zendshl_Http_UserAgent_Features_Adapter_WurflApi';
