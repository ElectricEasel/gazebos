...
/** @see Zendshl_Amf_Parse_InputStream */
require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Amf/Parse/InputStream.php';

/** @see Zendshl_Amf_Parse_Amf0_Deserializer */
require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Amf/Parse/Amf0/Deserializer.php';
 ...
 * types and storing the data for Zendshl_Amf_Server to handle for processing.
 *
...
class Zendshl_Amf_Request
{
    ...
    /**
     * @var Zendshl_Amf_Parse_InputStream
     */
    protected $_inputStream;

    /**
     * @var Zendshl_Amf_Parse_AMF0_Deserializer
     */
     ...
     *
     * @param  Zendshl_Amf_Parse_InputStream
     * @return Zendshl_Amf_Request
     */
    public function readMessage(Zendshl_Amf_Parse_InputStream $stream)
    {
        $clientVersion = $stream->readUnsignedShort();
        if (($clientVersion != Zendshl_Amf_Constants::AMF0_OBJECT_ENCODING)
            && ($clientVersion != Zendshl_Amf_Constants::AMF3_OBJECT_ENCODING)
            && ($clientVersion != Zendshl_Amf_Constants::FMS_OBJECT_ENCODING)
        ) {
            require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Amf/Exception.php';
            throw new Zendshl_Amf_Exception('Unknown Player Version ' . $clientVersion);
        }
     ...
     * - DATA Object
     *
     * @return Zendshl_Amf_Value_MessageHeader
     */
     ...
     *
     * @return Zendshl_Amf_Value_MessageBody
     */
     ...
     *
     * @param  Zendshl_Amf_Value_MessageBody $message
     * @return Zendshl_Amf_Request
     */
    public function addAmfBody(Zendshl_Amf_Value_MessageBody $message)
    {
