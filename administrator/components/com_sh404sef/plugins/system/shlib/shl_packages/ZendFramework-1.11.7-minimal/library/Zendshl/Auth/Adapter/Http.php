 ...
 */
class Zendshl_Auth_Adapter_Http implements Zendshl_Auth_Adapter_Interface
{
    /**
     * Reference to the HTTP Request object
     *
     * @var Zendshl_Controller_Request_Http
     */
    protected $_request;
     ...
     *
     * @var Zendshl_Controller_Response_Http
     */
    protected $_response;
     ...
     *
     * @var Zendshl_Auth_Adapter_Http_Resolver_Interface
     */
    ...
    public function __construct(array $config)
    {
        if (!extension_loaded('hash')) {
            ...
            throw new Zendshl_Auth_Adapter_Exception(__CLASS__  . ' requires the \'hash\' extension');
        }
        ...
        if (empty($config['accept_schemes'])) {
             ...
             */
            require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Auth/Adapter/Exception.php';
            throw new Zendshl_Auth_Adapter_Exception('Config key \'accept_schemes\' is required');
        }
        ...
        if (empty($this->_acceptSchemes)) {
             ...
             */
            require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Auth/Adapter/Exception.php';
            throw new Zendshl_Auth_Adapter_Exception('No supported schemes given in \'accept_schemes\'. Valid values: '
        ...
        if (empty($config['realm']) ||
             ...
             */
            require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Auth/Adapter/Exception.php';
            throw new Zendshl_Auth_Adapter_Exception('Config key \'realm\' is required, and must contain only printable '
        ...
        if (in_array('digest', $this->_acceptSchemes)) {
            if (empty($config['digest_domains']) ||
                 ...
                 */
                require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Auth/Adapter/Exception.php';
                throw new Zendshl_Auth_Adapter_Exception('Config key \'digest_domains\' is required, and must contain '
            ...
            if (empty($config['nonce_timeout']) ||
                 ...
                 */
                require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Auth/Adapter/Exception.php';
                throw new Zendshl_Auth_Adapter_Exception('Config key \'nonce_timeout\' is required, and must be an '
                                                    . 'integer');
            } else {
     ...
     *
     * @param  Zendshl_Auth_Adapter_Http_Resolver_Interface $resolver
     * @return Zendshl_Auth_Adapter_Http Provides a fluent interface
     */
    public function setBasicResolver(Zendshl_Auth_Adapter_Http_Resolver_Interface $resolver)
    {
     ...
     *
     * @return Zendshl_Auth_Adapter_Http_Resolver_Interface
     */
     ...
     * @return Zendshl_Auth_Adapter_Http Provides a fluent interface
     */
    public function setDigestResolver(Zendshl_Auth_Adapter_Http_Resolver_Interface $resolver)
    {
     ...
     *
     * @param  Zendshl_Controller_Request_Http $request
     * @return Zendshl_Auth_Adapter_Http Provides a fluent interface
     */
    public function setRequest(Zendshl_Controller_Request_Http $request)
    {
     ...
     *
     * @return Zendshl_Controller_Request_Http
     */
     ...
     *
     * @param  Zendshl_Controller_Response_Http $response
     * @return Zendshl_Auth_Adapter_Http Provides a fluent interface
     */
    public function setResponse(Zendshl_Controller_Response_Http $response)
    {
     ...
     *
     * @return Zendshl_Controller_Response_Http
     */
    ...
    public function authenticate()
    {
        if (empty($this->_request) ||
             ...
             */
            require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Auth/Adapter/Exception.php';
            throw new Zendshl_Auth_Adapter_Exception('Request and Response objects must be set before calling '
                                                . 'authenticate()');
        }
        ...
        if (!in_array($clientScheme, $this->_supportedSchemes)) {
            ...
            return new Zendshl_Auth_Result(
                Zendshl_Auth_Result::FAILURE_UNCATEGORIZED,
                array(),
        ...
        switch ($clientScheme) {
            ...
            default:
                 ...
                 */
                require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Auth/Adapter/Exception.php';
                throw new Zendshl_Auth_Adapter_Exception('Unsupported authentication scheme');
        }
     ...
     *
     * @return Zendshl_Auth_Result Always returns a non-identity Auth result
     */
    protected function _challengeClient()
    {
        ...
        return new Zendshl_Auth_Result(
            Zendshl_Auth_Result::FAILURE_CREDENTIAL_INVALID,
            array(),
    ...
    protected function _basicAuth($header)
    {
        if (empty($header)) {
             ...
             */
            require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Auth/Adapter/Exception.php';
            throw new Zendshl_Auth_Adapter_Exception('The value of the client Authorization header is required');
        }
        if (empty($this->_basicResolver)) {
             ...
             */
            require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Auth/Adapter/Exception.php';
            throw new Zendshl_Auth_Adapter_Exception('A basicResolver object must be set before doing Basic '
                                                . 'authentication');
        }
        ...
        if (!$auth) {
             ...
             */
            require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Auth/Adapter/Exception.php';
            throw new Zendshl_Auth_Adapter_Exception('Unable to base64_decode Authorization header value');
        }
        ...
        if ($password && $this->_secureStringCompare($password, $creds[1])) {
            ...
            return new Zendshl_Auth_Result(Zendshl_Auth_Result::SUCCESS, $identity);
        } else {
            return $this->_challengeClient();
        }
    }
     ...
     * @param  string $header Client's Authorization header
     * @throws Zendshl_Auth_Adapter_Exception
     * @return Zendshl_Auth_Result Valid auth result only on successful auth
     */
    protected function _digestAuth($header)
    {
        ...
        if (empty($this->_digestResolver)) {
             ...
             */
            require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Auth/Adapter/Exception.php';
            throw new Zendshl_Auth_Adapter_Exception('A digestResolver object must be set before doing Digest authentication');
        }
        ...
        switch ($data['qop']) {
            ...
            default:
                 ...
                 */
                require_once SHLIB_PATH_TO_ZEND . 'Zendshl/Auth/Adapter/Exception.php';
                throw new Zendshl_Auth_Adapter_Exception('Client requested an unsupported qop option');
        }
