...
/**
 * Node Tree class for Zendshl_Server reflection operations
 *
 * @category   Zend
 * @package    Zendshl_Server
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zendshl_Server_Reflection_Node
{
    /**
     * Node value
     * @var mixed
    ...
    /**
     * Parent node (if any)
     * @var Zendshl_Server_Reflection_Node
     */
     ...
     *
     * @param mixed $value
     * @param Zendshl_Server_Reflection_Node $parent Optional
     * @return Zendshl_Server_Reflection_Node
     */
    public function __construct($value, Zendshl_Server_Reflection_Node $parent = null)
    {
        $this->_value = $value;
        if (null !== $parent) {
     ...
     * Set parent node
     *
     * @param Zendshl_Server_Reflection_Node $node
     * @param boolean $new Whether or not the child node is newly created
     * and should always be attached
     * @return void
     */
    public function setParent(Zendshl_Server_Reflection_Node $node, $new = false)
    {
        $this->_parent = $node;
     ...
     * @param mixed $value
     * @access public
     * @return Zendshl_Server_Reflection_Node New child node
     */
     ...
     * @return void
     */
    public function attachChild(Zendshl_Server_Reflection_Node $node)
    {
        $this->_children[] = $node;
     ...
     *
     * @return null|Zendshl_Server_Reflection_Node
     */
