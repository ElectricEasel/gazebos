...
class Sh404sefClassConfig
{
	...
	public $shSecEnableSecurity = true;
	public $shSecLogAttacks = true;
	...
	public $shSecActivateAntiFlood = true;
	...
	// 3.4
	public $enableMultiLingualSupport = false;
