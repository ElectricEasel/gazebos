...
class GazebosModelProduct extends EEModelAdmin
{
	/**
	...
	{
		return new GazebosTableProduct;
	}
	...
	protected function prepareTable(&$table)
	{
		if (empty($table->id))
		{
			...
			if (@$table->ordering === '')
			{
				$table->ordering = $this->getDbo()->setQuery('SELECT (MAX(ordering) + 1) FROM #__gazebos_products')->loadResult();
			}
