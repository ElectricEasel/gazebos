		...
		for ($i = 0; $i < $total; $i++)
		{
			...
			$html[] = '<div class="specHolder" style="width:300px;">';
				$html[] = '<div style="display:block;width:300px">';
					$html[] = '<input type="text" value="'.$specs['title'][$i].'" style="width:300px" name="jform[specifications][title][]" />';
				$html[] = '</div>';
				$html[] = '<div style="display:block;width:300px">';
					$html[] = '<textarea style="width:300px;height:100px;resize:none;" name="jform[specifications][value][]">'.$specs['value'][$i].'</textarea>';
				$html[] = '</div>';
				$html[] = '<div style="display:block;width:300px">';
