...
class GazebosViewProducts extends EEViewAdminList
{
	protected $singleItemView = 'product';
	...
	protected function addToolbar()
	{
		...
		if (file_exists($formPath))
		{
			if ($canDo->get('core.create'))
			{
				...
				JToolBar::getInstance('toolbar')->appendButton('Popup', 'new', 'JTOOLBAR_NEW', 'index.php?option=com_gazebos&amp;view=select&amp;tmpl=component', 500, 300);
			}
