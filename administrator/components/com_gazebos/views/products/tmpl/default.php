...
<form action="<?php echo JRoute::_('index.php?option=com_gazebos&view=products'); ?>" method="post" name="adminForm" id="adminForm">
	<fieldset id="filter-bar">
		...
		<div class='filter-select fltrt'>
			...
			<?php echo $form->getInput('filter_style_id', null, $this->state->get('filter.style_id')); ?>
			<?php echo $form->getInput('filter_shape_id', null, $this->state->get('filter.shape_id')); ?>
			<?php echo $form->getInput('filter_material_id', null, $this->state->get('filter.material_id')); ?>
	...
	<table class="adminlist">
		...
		<?php foreach ($this->items as $i => $item) : ?>
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					<?php echo $item->style_title; ?>
				</td>
				<td>
					<?php echo $item->shape_title; ?>
				</td>
				<td>
					<?php echo $item->material_title; ?>
				</td>
