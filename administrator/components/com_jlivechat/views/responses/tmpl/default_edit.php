...
<form action="index.php?option=com_jlivechat&view=responses" method="post" name="adminForm" id="adminForm">
	...
	<tr>
	    ...
	    <td><input type="text" id="response_name" name="response_name" value="<?php echo JRequest::getVar('response_name', $this->response['response_name'], 'method'); ?>" size="30" /></td>
	</tr>
	<tr>
		...
		<div class="category-wrapper">
		    <input type="text" id="response_category" name="response_category" value="<?php echo JRequest::getVar('response_category', $this->response['response_category'], 'method'); ?>" size="30" />
		    <div class="clr">&nbsp;</div>
	...
	<tr>
	    ...
	    <td>
		<?php
		    echo $this->editor->display('response_txt', JRequest::getVar('response_txt', $this->response['response_txt'], 'method', 'string', JREQUEST_ALLOWRAW), '520', '210', '60', '10', false);
		?>
	    </td>
	</tr>
    </table>
    ...
    <div class="clr">&nbsp;</div>
    <input type="hidden" name="task" value="update_response" />
    <input type="hidden" name="response_id" value="<?php echo JRequest::getInt('response_id', 0, 'method'); ?>" />
