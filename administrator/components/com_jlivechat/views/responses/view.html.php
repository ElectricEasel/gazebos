...
class JLiveChatViewResponses extends JView
{
	...
	$this->assign('uri', $uri);
	$this->assign('response_categories', $responses->getCategories());

	if(JRequest::getInt('response_id', null, 'method'))
	{
	    $this->assign('response', $responses->getResponse(JRequest::getInt('response_id', null, 'method')));
	}
	...
	$document->addStyleSheet('components/com_jlivechat/assets/css/responses.css');
    }
	...
	$document->addScript('components/com_jlivechat/js/responses.js');
    }
}
