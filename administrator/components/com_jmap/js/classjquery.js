//Implementazione OOP Class paradigm in JS con JQuery
//Supporto ereditarietà con funzione extend ricorsiva tramite callee
(function(){
  var initializing = false,
    fnTest = /xyz/.test(function(){xyz;}) ? /\b_super\b/ : /.*/;
    
  jQuery.newClass = function(){};

  // Create a new Class that inherits from this class
  jQuery.newClass = function(prop) {
